...
class Development(Config):
  ...
  # If not filled anything then default value is Mighty User.
  ALIVE_NAME = "Mighty User"
  ...
  # Create a private group and add @missrose_bot to it.
